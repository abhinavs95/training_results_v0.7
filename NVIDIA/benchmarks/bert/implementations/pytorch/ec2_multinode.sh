...
_cont_mounts=("--volume=/home/ubuntu/training_results_v0.7/NVIDIA/benchmarks/bert/implementations/pytorch/:/workspace/pytorch" "--volume=${DATADIR}:/workspace/data" "--volume=${DATADIR_PHASE2}:/workspace/data_phase2" "--volume=${CHECKPOINTDIR}:/results" "--volume=${CHECKPOINTDIR_PHASE1}:/workspace/phase1" "--volume=${EVALDIR}:/workspace/evaldata")
...
"--master_port=${MASTER_PORT}"  "--nnodes=${NNODES}")
